...
var TimesIcon = React8.memo(React8.forwardRef(function(inProps, ref) {
...
var OverlayPanel = React9.forwardRef(function(inProps, ref) {
  var mergeProps = useMergeProps();
  var context = React9.useContext(PrimeReactContext);
  var props = OverlayPanelBase.getProps(inProps, context);
  var _React$useState = React9.useState(false), _React$useState2 = _slicedToArray(_React$useState, 2), visibleState = _React$useState2[0], setVisibleState = _React$useState2[1];
  ...
  var attributeSelector = React9.useRef("");
  var overlayRef = React9.useRef(null);
  var currentTargetRef = React9.useRef(null);
  var isPanelClicked = React9.useRef(false);
  var styleElement = React9.useRef(null);
  var overlayEventListener = React9.useRef(null);
  ...
  var createCloseIcon = function createCloseIcon2() {
    ...
    var icon = props.closeIcon || React9.createElement(TimesIcon, closeIconProps);
    ...
    if (props.showCloseIcon) {
      return React9.createElement("button", closeButtonProps, closeIcon, React9.createElement(Ripple, null));
    }
    return null;
  };
  var createElement4 = function createElement5() {
    ...
    return React9.createElement(CSSTransition2, _extends3({
      nodeRef: overlayRef
    }, transitionProps), React9.createElement("div", _extends3({
      ref: overlayRef
    }, rootProps), React9.createElement("div", contentProps, props.children), closeIcon));
  };
